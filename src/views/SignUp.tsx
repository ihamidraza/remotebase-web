...
export function SignUp(props: any) {
  ...
  >
    ...
    <Form.Item {...tailFormItemLayout}>
      <Button size='large' type="primary" htmlType="submit" style={{width: 200, marginRight: '1rem'}}>
        Register
      </Button>
      <Link to='/'>
