...
import {
  UserOutlined, ContactsOutlined, MailOutlined, TeamOutlined, NotificationOutlined,
  PhoneOutlined, TrophyOutlined, VideoCameraOutlined, PoweroffOutlined
  ...
  return (
    ...
    >
      ...
      <Menu theme="light" mode="inline" selectedKeys={selectedKey}>
        ...
        <Menu.Item key={'logout'} icon={<PoweroffOutlined />} onClick={() => {
